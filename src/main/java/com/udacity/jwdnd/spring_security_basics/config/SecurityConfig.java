...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .logout().permitAll()
                .logoutUrl("/logout")
               /* .logoutSuccessUrl("/logout") to enable "You have been logged out", عشان الrequest يبقى فيه param=logout
                     اما لو خليت الredirection يحصل هناو الrequest هيرح login عادي
                */
